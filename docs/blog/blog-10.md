...
$$X^* = \frac{\sum (d_i \times x_i)}{\sum d_i}$$

Trong đó $d_i$ là nhu cầu tại điểm $i$ và $x_i$ là tọa độ điểm $i$. Nói đơn giản: kho nên đặt **gần nơi nhu cầu cao nhất**, có trọng số theo khối lượng hàng. Giống như bạn chọn chỗ ở giữa cơ quan và nhà bạn gái — ai quan trọng hơn thì ở gần hơn! 😄
